...
1. [Fork](https://github.com/qualcomm-linux/pkg-rpm-kgsl/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-rpm-kgsl.git
    ```

1. Create a new branch based on `c10s`:

    ```bash
    git checkout -b <my-branch-name> c10s
    ```

1. Create an upstream `remote` to make it easier to keep your branches up-to-date:

    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-rpm-kgsl.git
    ```
